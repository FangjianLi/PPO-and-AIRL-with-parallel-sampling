...
class Discriminator:
    ...
    def construct_network(self, input):
        layer_1 = tf.layers.dense(inputs=input, units=64, activation=tf.nn.leaky_relu, name='layer1')
        layer_2 = tf.layers.dense(inputs=layer_1, units=64, activation=tf.nn.leaky_relu, name='layer2')
        layer_3 = tf.layers.dense(inputs=layer_2, units=64, activation=tf.nn.leaky_relu, name='layer3')
